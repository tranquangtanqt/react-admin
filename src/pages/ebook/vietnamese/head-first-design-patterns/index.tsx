    ...
    <>
      ...
      <div className="tab-1">
        ...
        <h2 class="wp-block-heading">
          <strong>Trong khi đó, trở lại PizzaStore …</strong>
        </h2>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh6.googleusercontent.com/nFfMKNweK-RkoW3XbABUYqX2QVxxdMNor7Pepc0hWgqCW5SpAW4XmJuUVvzRbsFOVB84xOLyIrnSFh9tWUsgkHI3lwjraCJ5VbK_Cj8jVlGp-lozJQaegHNvXuKZiLoSVOdKGI7N"
              alt="Pizza"
            />
          </figure>
        </div>
        ...
        <h3 class="wp-block-heading">
          <strong>Đảm bảo tính nhất quán trong thành phần của pizza</strong>
        </h3>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh6.googleusercontent.com/bAU0GH9u4iwbvNYo60iZLxl_hD7cYelgdswhKz-2naFMxmEAiTCvK3JYVwW3z7821HmD8B7IsbFw0FwXZfQ3G9EFRTSI7D-pyF673DDZjuabnrkyVkzRLIuKXnDmFr0e87hTuoo_"
              alt="Thực đơn pizza của Chicago và New York"
            />
          </figure>
        </div>

        <h2 class="wp-block-heading">
          <strong>Bộ nguyên liệu …</strong>
        </h2>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh3.googleusercontent.com/dagpR_5fEwJscRnOmnLZV6qqrFhbM42irfQprr9KNHo_EF1MoJRqpm_3XFEVNljvjLdqSkuL5Wrm8QW0dD75F0HOoTi3qC18CV6TYT8Fxcj0-Cr8op1A1Pcxk8bRx8OXcQ_qNcpT"
              alt="Sơ đồ lớp"
            />
          </figure>
        </div>
        ...
        <h2 class="wp-block-heading">
          <strong>Xây dựng nhà máy nguyên liệu</strong>
        </h2>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh3.googleusercontent.com/eawrSGAX2G7sohq-Ac74y0RRO-0FqPazyyKqujoIwUeApRk5rxS1aKT3k3ZV_MdfBhE5XySKFBqMGGTv8rkBEN8mJMQsWmnDgKrp8rR2L3g7JxWFBmf4OEva_0FAqlDhTY3eckR1"
              alt="Nhà máy sản xuất nguyên liệu pizza"
            />
          </figure>
        </div>
        ...
        <h2 class="wp-block-heading">
          <strong>Xây dựng nhà máy sản xuất nguyên liệu ở New York</strong>
        </h2>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh6.googleusercontent.com/2iOqlgu9-ugqFsZzoMuc6c5vbTuoV1k3ZxJ_Aw6gfL-TBS4yfxRnw9URyaShApnVEwOUh0NlXaTLncS2urFb6YwyFftAzK2Bxzwd0ZhB_sORwXRa17iOduv7Ou3ql6xeY9dU2AVA"
              alt="Nhà máy này chuyên về sốt Marinara, phô mai Reggiano, Fresh Clams"
            />
          </figure>
        </div>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh5.googleusercontent.com/RMmJOiJiRlQf8JsIeH80aFt9eaZGDCOb753l0zKKbExhGrG_Z_OPsEU3dcVLI11cdU3OdW9VmtaoclPH_1m4Ui3X4UIYvBKudkKRgimpKn6sZv-xUwOoF6RtI56tuJlWh4ZPCz2G"
              alt="ChicagoPizzaIngredientFactory"
            />
          </figure>
        </div>

        <h2 class="wp-block-heading">
          <strong>Làm lại lớp Pizza …</strong>
        </h2>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh5.googleusercontent.com/BegYdhPNUlVf1DI0OeLSzjyl-i4T2_unFM6CxsterQfIXzdAegbNxnsc2I5vqMG1UQ2wa3O87O4jz1-DeqGAFtm2rbXJif3RQeW4QPm--YpGwaLLTMZ8HIWRJ1OPbWiEMJaD-aPM"
              alt="Abstract class Pizza"
            />
          </figure>
        </div>

        <h2 class="wp-block-heading">
          <strong>Tiếp tục</strong> l<strong>àm lại lớp Pizza …</strong>
        </h2>
        ...
        >
          ...
          >
            <div
              id="aswift_2_host"
              style="border: none; height: 280px; width: 960px; margin: 0px; padding: 0px; position: relative; visibility: visible; background-color: transparent; display: inline-block;"
            ></div>
          </ins>
        </div>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh5.googleusercontent.com/Sq4pBtbJJJ336ZeTqYOmWILfaxhOY2tY3O6YJX9w544euGIEF1GXum3KmdhTm89eM5p-dvcwFQLPIyYMEtAmzMX3i_OIrYkwW1OqE2q-f6m5HNz-Ybclx9N0b6Y_iR6Fj0azigVw"
              alt="Cheese Pizza"
            />
          </figure>
        </div>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh4.googleusercontent.com/YCtSGtc1WLwjBHBaScURlyzyQjaGkX5OylFb5wIxBjP0DFspMH72bMKnVhoxDDiryWEfioPV1X0BWHD9ILACiVLuEafEsYT5b4Qr2g4jzuBKEA5L8FHu28UM_MY9ARA6F1hzf0Z8"
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh6.googleusercontent.com/KovkLo0zGw4M89-ijKGeKIAD3E6QLeGiHHD-MEhliwWuZNMbHIfI7gciBmkBLqyRy51A3WVD0IQKKciLlz6bZhw8CJe4GLcoZ6rNwmLajDcPhRagjZ5E-AzZI5AdU74KwY2IvED0"
              alt="Abstract Factory Pattern"
            />
          </figure>
        </div>
        ...
        <h2 class="wp-block-heading">
          <strong>Xem lại các cửa hàng pizza của chúng ta</strong>
        </h2>
        ...
        <figure class="wp-block-image">
          <img
            decoding="async"
            src="https://lh3.googleusercontent.com/LWILFjbOoSmfbLYNPaS1okSSXxHPREIYOazbwDoylbxaEImmcuwY8niC59F-EthYhgenZYrwZPmBgRo1Rt8qXmnz06BET_Uhc6Vn8jqqqrcAnaE09mTb6Dvi_3Cso6Xoh9iWDc7q"
            alt="Lớp NYPizzaIngredientFactory"
          />
        </figure>
        ...
        <h2 class="wp-block-heading">
          <strong>Chúng ta đã làm được gì?</strong>
        </h2>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh4.googleusercontent.com/24vZKkBLpJaf9HLUcDB_IeflRCHuCwO_k-68M8MA6QIISstrRI_BftXumyP3gVC-bQVN2H14Hc0YbC5VbIf1c5i4znpMz9tJ5cqH37DVZjhJgkHpFp17SDcz5LPH9F1RkX_Rmv7E"
              alt="Abstract Factory Pizza"
            />
          </figure>
        </div>

        <h2 class="wp-block-heading">
          <strong>Nhiều pizza hơn cho Ethan và Joel…&nbsp;&nbsp;</strong>
        </h2>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh4.googleusercontent.com/-jwyQzdBZqZtEjQfPpw-1Rb3n5orKBTu9Z0LGIYH_4uGObyXdXgpqewJoctAxK3fgldhkK5YATAsMvwj4ZN4uOMGcJU-JGbntiMI9domiQFUKsAnXBUbPqNiRx9iCmR56SsW_iFm"
              alt="Abstract Factory Pattern"
            />
          </figure>
        </div>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh4.googleusercontent.com/D78EN2q98rM4c1Pz7Y1org1Wb9YqzRwYHtGmFzMGH4C6GgwxKH5-kZ37apxcLqkSwQFY_Tx1wPTKbC3NUgqQFzQqdKRlmHnZrvR6BFn1VWl8EOrCAXfUhwg6E7ebW7hw411_kIVM"
              alt="quy trình đặt hàng pizza"
            />
          </figure>
        </div>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh6.googleusercontent.com/9Rjl0yRBiffIEBiAUXe9PkoVetEstcoGN8jYob8aS_DmlFIpsGG0IeCEPHN59GAzcxRBBw3z1KC5gwvc6UiqAn7_VJF_s8oyu-cF4aFdARU66mWlWHjli6hGPPaFPpvXBRpCpYh2"
              alt="quy trình đặt hàng pizza"
            />
          </figure>
        </div>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh3.googleusercontent.com/KmbV1brorVQRx76TbS3A_1SThXOL4ocFFyOE5ux_hyZmZfegS1H5BiVgEI-1-7UldfyWZ-6hsZpA5zR6pDddjdI0HJJnPaGlw8JN_-ZOswspwtAigq4-bjEmLfL_wSZJLdTjjA85"
              alt="Định nghĩa Abstract Factory Pattern"
            />
          </figure>
        </div>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh5.googleusercontent.com/_f4g0XIbBH2ya93BxhdVGt948tV89jZOXP5OXWCW299rHoXj22JUHALJX2yVckUID9YbrmCDrCF48pzZfg-Ca-jmVVGzmUU3itDZqibpYvcTwcXHRVmfvHaZgRqF4-iJZUG2b1-b"
              alt="Sơ đồ lớp Abstract Factory Pattern"
            />
          </figure>
        </div>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh6.googleusercontent.com/UMMeFeCCcWj2JxvFp0nmU93p40Zy-vfPv86ylPicbB4qW1pC6DKEA-CW1i74TPcTe3crdh67jv-qbREFrkE8SxA2MnMYyoyNUH9rhVgrwqm_cxSOQdYv2roKdVr22UVJbwc_l6YC"
              alt="Sơ đồ lớp Pizza"
            />
          </figure>
        </div>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh3.googleusercontent.com/pxuJI8FiFGlBUqj8g96ixnz535wSI4ggZdAs8jYjjG7vPgHUmvR5lnd554a5PofCAxRy0b_BLROqw5MntdvLdVzqtEmjPjgM1mKp8OoTzREszp3eYIeuuS_x-4oTPYrr5p2dMbxW"
              alt="Abstract Factory Pattern trông giống như Factory Pattern?"
            />
          </figure>
        </div>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh4.googleusercontent.com/JUGkB1_u0a_ssSDN9u_zKsfx_wxdCGELGlGE71GnWBDEH2C6yqw9LLTATrw-VQ8-xM0iaadfslN2gcWhAPOzw5h67lkmJ3GmrpN8vo-cOtzn0Z1r6Dpl_tFOjF3JCOjV64R22yGg"
              alt="Sơ đồ lớp Pizza"
            />
          </figure>
        </div>
        ...
        <div class="wp-block-image">
          <figure class="aligncenter">
            <img
              decoding="async"
              src="https://lh4.googleusercontent.com/7sqd_PSuxNU-lKNUqt9KKwvwPMI0OouvifCQqXyGTajKdDTlmnIqP8N-Bu6jMemma-XismLY-F1F8SDYCBrO2_TiWVz8QuxC8fAkMq-oCRJi4Wf17pJL9k-yEfNJ0_ZGYIULpEy1"
              alt="Sơ đồ lớp Pizza"
            />
          </figure>
        </div>

    ...
    <>
      ...
      <div className="row mt-2">
        <div className="col-12 col-sm-12 col-md-12">
          ...
          <div className="tab-1">
            <p>
              Numeric primitives can be cast in two ways. Implicit casting happens when the source type has smaller
      ...
      <div className="row mt-2">
        <div className="col-12 col-sm-12 col-md-12">
          ...
          <div className="tab-1">
            ...
            <p>
              A char can be cast to/from any numeric type by using the code-point mappings specified by Unicode. A char
              is represented in memory as an unsigned 16-bit integer value (2 bytes), so casting to byte (1 byte) will
              drop 8 of those bits (this is safe for ASCII characters). The utility methods of the Character class use
              int (4 bytes) to transfer to/from code-point values, but a short (2 bytes) would also suffice for storing
        ...
        <div className="col-12 col-sm-12 col-md-12">
          ...
          <div className="tab-1">
            ...
            <p>
              ...
              (casting to a subtype). This can produce a runtime exception (ClassCastException) when the object being
              cast is not of the target type (or the target's subtype).
            </p>
          </div>
          <div className="tab-2">
            <Code

  ...
  return (
    <>
      ...
      <div className="row mt-2">
        <div className="col-12 col-sm-12 col-md-12">
          ...
          <div className="tab-1">
            <p>
              Setters and Getters allow for an object to contain private variables which can be accessed and changed
        ...
        this.name = name;
          ...
          <div className="tab-1">
            <p>
              ...
              method and changed using the setName(String) method, however, setting a name requires the new name to have
              a length greater than 2 characters and to not be null. Using a setter method rather than making the
              variable name public allows others to set the value of name with certain restrictions. The same can be
              applied to the getter method:
            </p>
          </div>
          <div className="tab-2">
            <Code
    ...
    if(name.length()>16)
        ...
        return name;
          ...
          <div className="tab-1">
            <p>
              In the modified getName() method above, the name is returned only if its length is less than or equal to
              16. Otherwise, "Name is too large" is returned. This allows the programmer to create variables that are
              reachable and modifiable however they wish, preventing client classes from editing the variables
              unwantedly.
            </p>
          </div>
        </div>
    ...
    public int count = 0;
          ...
          <div className="tab-2">
            <ul>
              <li>
                First: "I have a method that will give you an int value, and a method that will set that value to
                another int".
              </li>
    ...
    public synchronized void setCount(int c) { count = c; }
          ...
          <div className="tab-1">
            <p>
              ...
              to be consumed by others, you do not have a way of performing that modification, and are forced to make
              the hard choice mentioned above.
            </p>
            <p>So it begs the question; are public variables ever a good thing (or, at least, not evil)?</p>
            <p>
              I'm unsure. On one hand, you can see examples of public variables that have stood the test of time (IE:
              the out variable referenced in System.out). On the other, providing a public variable gives no benefit
              outside of extremely minimal overhead and potential reduction in wordiness. My guideline here would be
              that, if you're planning on making a variable public, you should judge it against these criteria with
              extreme prejudice:
            </p>
          </div>
          <div className="tab-2">
            <ol>
              <li>
                ...
                why getters/setters are the common approach. If you're going to have a public variable, this really
                needs to be thought through, especially if released in a library/framework/API.
              </li>
              <li>
                ...
                considered here. It's far too negligible for what I'd conservatively estimate to be 99.9% of
                applications.
              </li>
            </ol>
          </div>
          <div className="tab-1">
            <p>
              There's probably more than I haven't considered off the top of my head. If you're ever in doubt, always
              use getters/setters.
            </p>
          </div>
        </div>
      ...
      <div className="row mt-2">
        <div className="col-12 col-sm-12 col-md-12">
          ...
          <div className="tab-1">
            <p>
              Encapsulation is a basic concept in OOP. It is about wrapping data and code as a single unit. In this
              case, it is a good practice to declare the variables as private and then access them through Getters and
              Setters to view and/or modify them.
            </p>
          </div>
          <div className="tab-2">
            <Code

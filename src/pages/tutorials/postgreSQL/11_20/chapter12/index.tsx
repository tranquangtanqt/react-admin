...
(8 rows)
    `}
          ...
          <div className="tab-2">
            <ul>
              <li>
                dist_by_i: DENSE_RANK() OVER (ORDER BY i) is like a row_number per distinct values. Can be used for the
                number of distinct values of i (COUNT(DISTINCT i) wold not work). Just use the maximum value.
              </li>
              <li>
...
FROM wf_example`}
          ...
          <div className="tab-1">
            <ul>
              <li>
                dense_rank orders VALUES of i by appearance in window. i=1 appears, so first row has dense_rank, next
                and third i value does not change, so it is dense_rank shows 1 - FIRST value not changed. fourth row
                i=2, it is second value of i met, so dense_rank shows 2, andso for the next row. Then it meets value i=3
                at 6th row, so it show 3. Same for the rest two values of i. So the last value of dense_rank is the
                number of distinct values of i
              </li>
              ...
              <li>
                ...
                three ones, but has next value 4, which means i=2 (new value) was met at row 4. Same i=3 was met at row
                6. Etc..
              </li>
            </ul>
          </div>
